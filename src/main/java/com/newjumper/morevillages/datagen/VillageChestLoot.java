...
public class VillageChestLoot implements LootTableSubProvider {
    public static final ResourceLocation VILLAGE_JUNGLE_HOUSE = new ResourceLocation(MoreVillages.MOD_ID, "chests/village/village_jungle_house");
