...
public class VillageStructures {
    ...
    public static void bootstrap(BootstapContext<Structure> context) {
        ...
        context.register(VILLAGE_JUNGLE, new JigsawStructure(structure(biomes.getOrThrow(MoreVillagesTags.HAS_VILLAGE_JUNGLE)), pools.getOrThrow(JungleVillagePools.START), 6, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
    }
