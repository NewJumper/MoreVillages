...
public class JungleVillagePools {
    ...
    public static void bootstrap(BootstapContext<StructureTemplatePool> context) {
        ...
        context.register(createKey("village/jungle/villagers"), new StructureTemplatePool(empty, ImmutableList.of(Pair.of(location("village/jungle/villagers/nitwit"), 1), Pair.of(location("village/jungle/villagers/baby"), 1), Pair.of(location("village/jungle/villagers/unemployed"), 10)), StructureTemplatePool.Projection.RIGID));
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> location(String name, Holder<StructureProcessorList> processor) {
        return (projection) -> new SinglePoolElement(Either.left(new ResourceLocation(MoreVillages.MOD_ID, name)), processor, projection) {};
    }
    
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> location(String name) {
        return (projection) -> new SinglePoolElement(Either.left(new ResourceLocation(MoreVillages.MOD_ID, name)), EMPTY, projection) {};
    }

    public static ResourceKey<StructureTemplatePool> createKey(String name) {
        return ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(MoreVillages.MOD_ID, name));
    }
}
